...
public class JoinSurveyCtrl {
    ...
    @PostMapping()
    public ResponseEntity<?> creatSurve(@Valid @RequestBody JoinSurveyDTO joinSurveyDTO,
    ...
    @GetMapping("/{userId}")
    public ResponseEntity<?> getJoinSurveyWihtUserId(@PathVariable Long userId) {
        try {
